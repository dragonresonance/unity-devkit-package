...
{
	[CreateAssetMenu(menuName = "PossumScream/Components/Savedata/String Savedata File", fileName = "New StringSavedata")]
	public class SOStringSavedata : ASavedataScriptableObject
	{
		[Header("Value")]
		/* 0 */ [SerializeField] private string _initial = default;
		/* 9 */ [SerializeField] private string _value = default;
		...
		#region Controls
			...
			[Button("Trim Value", EButtonEnableMode.Always)]
