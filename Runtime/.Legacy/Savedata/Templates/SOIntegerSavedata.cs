...
{
	[CreateAssetMenu(menuName = "PossumScream/Components/Savedata/Integer Savedata File", fileName = "New IntegerSavedata")]
	public class SOIntegerSavedata : ASavedataScriptableObject
	{
		[Header("Value")]
		/* 0 */ [SerializeField] private int _initial = default;
		/* 9 */ [SerializeField] private int _value = default;
