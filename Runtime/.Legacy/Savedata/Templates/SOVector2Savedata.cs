...
{
	[CreateAssetMenu(menuName = "PossumScream/Components/Savedata/Vector2 Savedata File", fileName = "New Vector2Savedata")]
	public class SOVector2Savedata : ASavedataScriptableObject
	{
		[Header("Value")]
		/* 0 */ [SerializeField] private Vector2 _initial = default;
		/* 9 */ [SerializeField] private Vector2 _value = default;
